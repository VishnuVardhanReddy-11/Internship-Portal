    ...
    <div className="font-sans text-gray-800 bg-gray-50 min-h-screen">
      ...
      <main>
        ...
        <section
          ...
          style={{
            background:
              "linear-gradient(to right, #6c5ce7e0, #8d7ee7e0), url('https://via.placeholder.com/1920x800/6C5CE7/ffffff?text=Hair+CoAction+Background') no-repeat center center/cover",
          }}
        >
          {/* Background overlay */}
          ...
          <div className="max-w-6xl mx-auto px-5 flex flex-col md:flex-row items-center gap-10 relative z-10">
            <div className="flex-1 max-w-2xl">
              ...
              <p className="text-xl md:text-2xl text-gray-200 leading-relaxed mb-10">
                Unlock your potential with expert courses, hands-on projects,
                and exclusive internship opportunities in the hair industry.
              </p>
              <div className="flex flex-col sm:flex-row gap-5">
                <a
                  href="#courses"
                  className="px-12 py-4 rounded-md font-semibold text-lg bg-[#6C5CE7] text-white border-2 border-[#6C5CE7] hover:bg-[#5B4DC0] hover:border-[#5B4DC0] hover:-translate-y-0.5 hover:shadow-md transition-all text-center"
                >
                  Explore Courses
                </a>
                <a
                  href="#internships"
                  className="px-12 py-4 rounded-md font-semibold text-lg bg-white text-[#6C5CE7] border-2 border-[#6C5CE7] hover:bg-[#6C5CE7] hover:text-white hover:-translate-y-0.5 hover:shadow-md transition-all text-center"
                >
                  Find Internships
                </a>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-gray-50 p-9 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-lg transition-all text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Master new techniques and business skills with our curated
                  online courses, taught by industry leaders.
                </p>
                <a
                  href="#courses"
                  className="text-[#6C5CE7] font-semibold hover:text-[#5B4DC0] transition-colors"
                >
                  Learn More{" "}
                  <i className="fas fa-arrow-right ml-2 transition-all hover:ml-3"></i>
                </a>
              </div>
              ...
              <div className="bg-gray-50 p-9 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-lg transition-all text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Apply your knowledge with real-world projects, build your
                  portfolio, and get valuable feedback.
                </p>
                <a
                  href="#projects"
                  className="text-[#6C5CE7] font-semibold hover:text-[#5B4DC0] transition-colors"
              ...
              <div className="bg-gray-50 p-9 rounded-xl shadow-md hover:-translate-y-2 hover:shadow-lg transition-all text-center">
                ...
                <p className="text-gray-600 mb-6">
                  Connect with top salons and studios for hands-on experience
        ...
        <section id="courses" className="bg-gray-100 py-12 md:py-24">
          <div className="max-w-6xl mx-auto px-5">
            ...
            <p className="max-w-3xl mx-auto text-xl text-gray-500 mb-16 text-center -mt-5">
              Dive into our diverse range of courses designed to elevate your
              craft.
            </p>
                ...
                {[
                  {
                    ...
                    description:
                      "Explore the foundations and applications of AI across industries.",
                    duration: "15 hours",
                    rating: "4.8 (420)",
                    image: "ai.png",
                  },
                  {
                    ...
                    instructor: "Jane Doe",
                    description:
                      "Explore the fundamentals of machine learning, including supervised and unsupervised learning, model evaluation, and real-world applications using Python.",
                    duration: "12 hours",
                    rating: "4.9 (512)",
                    image: "ml.png",
                  },
                  {
                    ...
                    description:
                      "Analyze data, create visualizations, and apply ML algorithms.",
                    duration: "14 hours",
                    rating: "4.9 (390)",
                    image: "data.png",
                  },
                  ...
                  >
                    ...
                    <div className="p-6 flex flex-col flex-grow">
                      ...
                      <div className="flex gap-4 text-sm text-gray-500 mb-5">
                        ...
                        <span>
                          <i className="fas fa-star text-[#6C5CE7] mr-1"></i>{" "}
                          {course.rating}
                        </span>
                      </div>
                      <Link
        ...
        <section id="cta-join" className="bg-[#6C5CE7] py-16 md:py-20">
          <div className="max-w-6xl mx-auto px-5 text-center">
            ...
            <p className="text-xl text-gray-200 mb-10 max-w-3xl mx-auto">
              Join the Hair Coaction community today and take the next step in
              your career.
            </p>
            <a
              href="#"
              className="inline-block px-10 py-4 rounded-md font-semibold text-lg bg-white text-[#6C5CE7] border-2 border-white hover:bg-[#6C5CE7] hover:text-white hover:-translate-y-0.5 hover:shadow-md transition-all"
            >
              Sign Up for Free!
            </a>
          </div>
