...
>
  ...
  <div className="flex space-x-6 min-w-[1024px] md:min-w-[1536px] px-1">
        ...
        <div className="bg-white rounded-lg shadow-md min-w-[300px] max-w-sm p-6 hover:-translate-y-2 hover:shadow-lg transition-all flex flex-col">
          ...
          <a href="/web" className="inline-block px-5 py-2.5 rounded-md font-semibold text-sm bg-[#6C5CE7] text-white border-2 border-[#6C5CE7] hover:bg-[#5B4DC0] hover:border-[#5B4DC0] transition-all text-center self-start">
            Apply Now
          </a>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md min-w-[300px] max-w-sm p-6 hover:-translate-y-2 hover:shadow-lg transition-all flex flex-col">
          ...
          <a href="/ai" className="inline-block px-5 py-2.5 rounded-md font-semibold text-sm bg-[#6C5CE7] text-white border-2 border-[#6C5CE7] hover:bg-[#5B4DC0] hover:border-[#5B4DC0] transition-all text-center self-start">
            Apply Now
          </a>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md min-w-[300px] max-w-sm p-6 hover:-translate-y-2 hover:shadow-lg transition-all flex flex-col">
          ...
          <a href="/applicationdev" className="inline-block px-5 py-2.5 rounded-md font-semibold text-sm bg-[#6C5CE7] text-white border-2 border-[#6C5CE7] hover:bg-[#5B4DC0] hover:border-[#5B4DC0] transition-all text-center self-start">
            Apply Now
          </a>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md min-w-[300px] max-w-sm p-6 hover:-translate-y-2 hover:shadow-lg transition-all flex flex-col">
          ...
          <a href="/devops" className="inline-block px-5 py-2.5 rounded-md font-semibold text-sm bg-[#6C5CE7] text-white border-2 border-[#6C5CE7] hover:bg-[#5B4DC0] hover:border-[#5B4DC0] transition-all text-center self-start">
            Apply Now
          </a>
        </div>
      </div>
