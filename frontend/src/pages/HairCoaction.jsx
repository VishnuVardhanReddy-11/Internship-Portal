    ...
    {[
      {
        ...
        description: "Work on frontend and backend features using React and Node.js",
      },
      {
        id: "ai",
        title: "Artificial Intelligence Intern",
        description: "Assist in model training and automation tasks using Python and TensorFlow",
      },
      {
        id: "app",
        title: "Application Development Intern",
        description: "Work on developing cross-platform mobile and web applications using Flutter and Node.js.",
      },
      {
        id: "devops",
        title: "DevOps Intern",
        description: "Work with CI/CD pipelines, Docker, Kubernetes, and cloud infrastructure",
      },
    ].map((intern) => (
      <div
        key={intern.id}
