...
const mockTrendingItemsData = [
  {
    ...
    description: "Understand AI strategy for enterprises.",
    duration: "6 weeks",
    type: "course",
  ...
  },
  {
    ...
    description: "Hands-on data analysis projects.",
    duration: "10 weeks",
    type: "project",
    domain: "Data Science",
    profession: "Working Professional",
  ...
  },
  {
    ...
    description: "Learn principles of mobile UI/UX.",
    duration: "5 weeks",
    type: "course",
    domain: "Design",
    profession: "College Student",
  ...
  },
  {
    ...
    description: "Prepare for common aptitude tests.",
    duration: "3 weeks",
    type: "course",
    domain: "General",
    profession: "College Student",
  ...
  },
  {
    ...
    description: "Build your first 3D game.",
    duration: "12 weeks",
    type: "project",
  ...
  },
  {
    ...
    description: "Basics of online advertising and SEO.",
    duration: "6 weeks",
    type: "course",
    domain: "Marketing",
    profession: "Working Professional",
  ...
  },
  {
    ...
    description: "Secure cloud deployments on AWS.",
    duration: "7 weeks",
    type: "course",
  ...
  },
  {
    ...
    profession: "College Student",
    program: "Community Programs",
    categories: ["Business", "Soft Skills"],
  },
];
// --- End of Mock Data ---
...
const Dashboard = () => {
  ...
  const allTrendingLearningOpportunities = useMemo(
    () => mockTrendingItemsData,
    []
  );
  ...
  useEffect(() => {
    ...
    if (selectedProfessionFilter) {
      filtered = filtered.filter(
        (item) => item.profession === selectedProfessionFilter
      );
    }

    if (selectedProgramFilter) {
      filtered = filtered.filter(
        (item) => item.program === selectedProgramFilter
      );
    }
    ...
    allTrendingLearningOpportunities,
  ]);
    ...
    <div className="containser">
      ...
      <div className="header">
        ...
        <div className="header-right-buttons">
          {/* <button className="enroll-new-btn" onClick={handleEnrollNewClick}>
            ...
            <div className="cert-grid">
              {certifications.length > 0 ? (
                ...
                <p
                  ...
                  style={{ gridColumn: "1 / -1" }}
                >
                  No certifications achieved yet. Keep learning and earn your
                  first one!
                </p>
              )}
            </div>
