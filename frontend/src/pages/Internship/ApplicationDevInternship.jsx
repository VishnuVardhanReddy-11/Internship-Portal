...
export default function ApplicationDevInternship() {
  ...
  return (
    <div
      ...
      style={{
        background: `linear-gradient(to right, #6c5ce7e0, #8d7ee7e0), url('https://via.placeholder.com/1920x800/6C5CE7/ffffff?text=App+Dev+Background') no-repeat center center / cover`,
      }}
    >
      <div className="max-w-7xl mx-auto px-5 py-10">
        <header className="text-center text-white mb-10 animate-fade-in-down">
          <h1 className="text-4xl md:text-5xl font-bold drop-shadow-lg">📱 Application Development Internship</h1>
          <p className="mt-2 text-lg">Build powerful mobile & web apps with real-world experience</p>
        </header>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          ...
          <div className="bg-white rounded-2xl p-6 shadow-xl h-fit sticky top-5 animate-fade-in-right">
            <form
              ...
              style={{
                background: `linear-gradient(to right, #6c5ce7e0, #8d7ee7e0), url('https://via.placeholder.com/1920x800/6C5CE7/ffffff?text=App+Dev+Form') no-repeat center center / cover`,
              }}
            >
